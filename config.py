...
IOT_ENABLED = True
VEHICLE_ID = 'donkey'
AWS_ENDPOINT = "auvz0fbaaf90k-ats.iot.us-east-1.amazonaws.com"
CA_PATH = os.path.join(CAR_PATH, '~/Desktop/aws')
PRIVATE_KEY_PATH = os.path.join(CAR_PATH, '~/Desktop/aws')
CERTIFICATE_PATH = os.path.join(CAR_PATH, '~/Desktop/aws')
